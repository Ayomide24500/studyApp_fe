...
const Dashboard = () => {
  ...
  const handlegetDetails = (studentID: any) => {
    getStudy(studentID)
      .then((res) => {
  ...
  return (
    <div>
      ...
      <div className="flex-1 p-4 sm:ml-64">
        {state.map((details: any) => (
          <section className="mb-8" key={details.id}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-white dark:bg-gray-800 p-4 rounded shadow-md">
                <p className="text-xl text-gray-600 dark:text-gray-400">
                  {details.studyDuration} hours
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-300">
                  Total Study Time: {details.totalTime} hours
                </p>
              </div>
              {/* ... other details */}
            </div>
        ...
        <button
          onClick={(studentID) => handlegetDetails(studentID)}
